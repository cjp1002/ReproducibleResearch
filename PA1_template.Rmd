...
The mean number of steps per day (with missing values imputed) is `r nonamean`
<br /><br /><br />
...
The median number of steps per day (with missing values imputed) is `r nonamedian`  
<br /><br />
**Comparing raw data mean and median steps per day with those where the missing values are imputed**

Mean (no imputed values) `r mean` , Mean (with imputed values) `r nonamean`

*...the difference between the two is `r nonamean-mean`*  
<br />
Median (no imputed values) `r median` , Median (with imputed values) `r nonamedian`

*...the difference between the two is `r nonamedian-median`*
<br /><br />
